<div class="d-none">
	<div id="content-for-quick-add-menu">
		<div>
			<ul>
				<li class="cf">
					<div class="lf f75"><?php echo EBE_get_lang('home'); ?></div>
					<div class="lf f25 text-center">
				...
				<li class="cf">
					<div class="lf f75"><?php echo EBE_get_lang('home'); ?></div>
					<div class="lf f25 text-center">
						<button data-link="aaaaaa" data-text="<?php echo EBE_get_lang('home'); ?>" type="button" class="cur click-to-add-custom-link"><i class="fa fa-plus"></i></button>
					</div>
				</li>
				<li class="cf">
					<div class="lf f75"><?php echo EBE_get_lang('cart'); ?></div>
					<div class="lf f25 text-center">
				...
				<li class="cf">
					<div class="lf f75"><?php echo EBE_get_lang('taikhoan'); ?></div>
					<div class="lf f25 text-center">
