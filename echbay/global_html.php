	...
	<div id="content-for-quick-add-menu">
		<ul class="buttom-for-quick-add-menu">
			...
			<li class="cf">
				...
				<div class="lf f20 text-center">
					<button data-link="#" data-text="Tên menu" data-css="wgr-load-js-category" type="button" class="cur click-to-add-custom-link"><i class="fa fa-plus"></i></button>
				</div>
			</li>
			<li class="cf">
				...
				<div class="lf f20 text-center">
					<button data-link="#" data-text="Tên menu" data-css="wgr-load-js-sub-category" type="button" class="cur click-to-add-custom-link"><i class="fa fa-plus"></i></button>
				</div>
			</li>
			<li class="cf">
				<div class="lf f80"><i class="fa fa-circle-o-notch"></i> JS Blogs <em class="small">(Tạo menu Danh mục Tin tức bằng Javascript)</em></div>
				<div class="lf f20 text-center">
					<button data-link="#" data-text="Tên menu" data-css="wgr-load-js-blogs" type="button" class="cur click-to-add-custom-link"><i class="fa fa-plus"></i></button>
				</div>
			</li>
			<li class="cf">
				...
				<div class="lf f20 text-center">
					<button data-link="#" data-text="Tên menu" data-css="wgr-load-js-sub-blogs" type="button" class="cur click-to-add-custom-link"><i class="fa fa-plus"></i></button>
				</div>
			</li>
			<li class="cf">
