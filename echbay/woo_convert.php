...
<h2>Convert các dữ liệu trong post meta sang Commerce hoặc ngược lại</h2>
<br>
<ol>
	<li><a href="<?php echo $convert_lnk; ?>">Woo to WebGiaRe</a></li>
	<li><a href="<?php echo $convert_lnk; ?>&mt=wgr">WebGiaRe to Woo</a></li>
	<li><a href="<?php echo $convert_lnk; ?>&mt=yoast">WebGiaRe to Yoast SEO</a></li>
	<li><a href="<?php echo $convert_lnk; ?>&mt=yoast_wgr">Yoast SEO to WebGiaRe</a></li>
	<li><a href="<?php echo $convert_lnk; ?>&mt=ultimate">WebGiaRe to SEO Ultimate</a></li>
	<li><a href="<?php echo $convert_lnk; ?>&mt=ultimatewgr_wgr">SEO Ultimate to WebGiaRe</a></li>
</ol>
<br>
<?php
