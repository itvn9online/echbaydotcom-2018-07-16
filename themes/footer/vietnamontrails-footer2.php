			...
			<div class="lf f75 fullsize-if-mobile">
				<div class="left-menu-space">
					...
					<ul class="footer-contact-content">
						<li><strong>Tours Operating Office:</strong> <?php echo nl2br( $__cf_row['cf_diachi'] ); ?></li>
						<li><strong>Tel:</strong> <?php echo $__cf_row['cf_call_hotline']; ?> - <span class="phone-numbers-inline"><?php echo $__cf_row['cf_call_dienthoai']; ?></span></li>
						<li><strong>Email:</strong> <a href="mailto:<?php echo $__cf_row['cf_email']; ?>" rel="nofollow" target="_blank"><?php echo $__cf_row['cf_email']; ?></a> </li>
					</ul>
				</div>
			</div>
		</div>
