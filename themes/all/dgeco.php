...
//
$eb_all_themes_support[$eb_all_themes_name]["top"][] = "dgeco-top1.php";
...
$eb_all_themes_support[$eb_all_themes_name]["footer"][] = "dgeco-footer1.php";
//$eb_all_themes_support[$eb_all_themes_name]["footer"][] = "echbaytwo-footer3.php";
//
//$eb_all_themes_support[$eb_all_themes_name]["home"][] = "dgeco-home1.php";
$eb_all_themes_support[$eb_all_themes_name]["home"][] = "home_widget.php";
//
$eb_all_themes_support[$eb_all_themes_name]["threaddetails"][] = "dgeco-threaddetails.html";
//
$eb_all_themes_support[$eb_all_themes_name]["threadnode"][] = "dgeco-threadnode.html";
