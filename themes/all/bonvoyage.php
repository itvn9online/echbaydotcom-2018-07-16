...
//
$eb_all_themes_support[$eb_all_themes_name]["top"][] = "bonvoyage-top1.php";
...
$eb_all_themes_support[$eb_all_themes_name]["footer"][] = "bonvoyage-footer1.php";
$eb_all_themes_support[$eb_all_themes_name]["footer"][] = "echbaytwo-footer3.php";
//
//$eb_all_themes_support[$eb_all_themes_name]["home"][] = "bonvoyage-home1.php";
$eb_all_themes_support[$eb_all_themes_name]["home"][] = "home_widget.php";
//
$eb_all_themes_support[$eb_all_themes_name]["threaddetails"][] = "bonvoyage-threaddetails.html";
//
$eb_all_themes_support[$eb_all_themes_name]["threadnode"][] = "bonvoyage-threadnode.html";
