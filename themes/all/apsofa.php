...
//
$eb_all_themes_support[$eb_all_themes_name]["top"][] = "apsofa-top1.php";
...
$eb_all_themes_support[$eb_all_themes_name]["footer"][] = "apsofa-footer1.php";
$eb_all_themes_support[$eb_all_themes_name]["footer"][] = "echbaytwo-footer3.php";
//
//$eb_all_themes_support[$eb_all_themes_name]["home"][] = "apsofa-home1.php";
$eb_all_themes_support[$eb_all_themes_name]["home"][] = "home_widget.php";
//
$eb_all_themes_support[$eb_all_themes_name]["threaddetails"][] = "apsofa-threaddetails.html";
//
$eb_all_themes_support[$eb_all_themes_name]["threadnode"][] = "apsofa-threadnode.html";
