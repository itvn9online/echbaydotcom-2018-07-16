<?php 
/*
* Save from Mon, 09 Apr 2018 03:24:36 +0700
* By itvn9online@yahoo.com #1
* From IP: 127.0.0.1
* On domain: localhost:8888
* User agent: Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/65.0.3325.181 Safari/537.36
*/
$eb_all_themes_name = 'phuhuyetkhang';
$eb_all_themes_support[$eb_all_themes_name] = array();
$eb_all_themes_support[$eb_all_themes_name]["name"] = $eb_all_themes_name;
$eb_all_themes_support[$eb_all_themes_name]["screenshot"] = "https://img1.webgiare.org/phuhuyetkhang.jpg";
$eb_all_themes_support[$eb_all_themes_name]["author"] = "";
$eb_all_themes_support[$eb_all_themes_name]["demo"] = "";
$eb_all_themes_support[$eb_all_themes_name]["price"] = 4000000;
//
$eb_all_themes_support[$eb_all_themes_name]["top"][] = "phuhuyetkhang-top1.php";
...
//
$eb_all_themes_support[$eb_all_themes_name]["threadnode"][] = "phuhuyetkhang-threadnode.html";
