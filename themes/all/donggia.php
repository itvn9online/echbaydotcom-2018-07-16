...
//
$eb_all_themes_support[$eb_all_themes_name]["top"][] = "donggia-top1.php";
...
//
//$eb_all_themes_support[$eb_all_themes_name]["home"][] = "donggia-home1.php";
$eb_all_themes_support[$eb_all_themes_name]["home"][] = "home_widget.php";
//
$eb_all_themes_support[$eb_all_themes_name]["threaddetails"][] = "donggia-threaddetails.html";
//
$eb_all_themes_support[$eb_all_themes_name]["threadnode"][] = "donggia-threadnode.html";
