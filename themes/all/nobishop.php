...
//
$eb_all_themes_support[$eb_all_themes_name]["top"][] = "nobishop-top1.php";
...
$eb_all_themes_support[$eb_all_themes_name]["footer"][] = "nobishop-footer1.php";
//$eb_all_themes_support[$eb_all_themes_name]["footer"][] = "echbaytwo-footer3.php";
//
//$eb_all_themes_support[$eb_all_themes_name]["home"][] = "nobishop-home1.php";
$eb_all_themes_support[$eb_all_themes_name]["home"][] = "home_widget.php";
//
$eb_all_themes_support[$eb_all_themes_name]["threaddetails"][] = "nobishop-threaddetails.html";
//
$eb_all_themes_support[$eb_all_themes_name]["threadnode"][] = "nobishop-threadnode.html";
