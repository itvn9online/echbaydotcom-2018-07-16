<?php 
/*
* Save from Tue, 09 Jan 2018 00:42:42 +0700
* By itvn9online@yahoo.com #1
* From IP: 127.0.0.1
* On domain: localhost:8888
* User agent: Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/63.0.3239.132 Safari/537.36
*/
$eb_all_themes_name = 'chungcuhalong';
$eb_all_themes_support[$eb_all_themes_name] = array();
$eb_all_themes_support[$eb_all_themes_name]["name"] = $eb_all_themes_name;
$eb_all_themes_support[$eb_all_themes_name]["screenshot"] = "https://img1.webgiare.org/chungcuhalong.jpg";
$eb_all_themes_support[$eb_all_themes_name]["author"] = "";
$eb_all_themes_support[$eb_all_themes_name]["demo"] = "";
$eb_all_themes_support[$eb_all_themes_name]["price"] = 3000000;
//
$eb_all_themes_support[$eb_all_themes_name]["top"][] = "chungcuhalong-top1.php";
...
$eb_all_themes_support[$eb_all_themes_name]["footer"][] = "chungcuhalong-footer1.php";
$eb_all_themes_support[$eb_all_themes_name]["footer"][] = "echbaytwo-footer3.php";
//
//$eb_all_themes_support[$eb_all_themes_name]["home"][] = "chungcuhalong-home1.php";
$eb_all_themes_support[$eb_all_themes_name]["home"][] = "home_widget.php";
//
$eb_all_themes_support[$eb_all_themes_name]["threaddetails"][] = "chungcuhalong-threaddetails.html";
//
$eb_all_themes_support[$eb_all_themes_name]["threadnode"][] = "chungcuhalong-threadnode.html";
