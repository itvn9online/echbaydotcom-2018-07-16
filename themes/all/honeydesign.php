...
*/
$eb_all_themes_name = 'honeydesign';
$eb_all_themes_support[$eb_all_themes_name] = array();
$eb_all_themes_support[$eb_all_themes_name]["name"] = $eb_all_themes_name;
$eb_all_themes_support[$eb_all_themes_name]["screenshot"] = "https://img1.webgiare.org/honeydesign.jpg";
...
//
$eb_all_themes_support[$eb_all_themes_name]["top"][] = "honeydesign-top1.php";
...
$eb_all_themes_support[$eb_all_themes_name]["footer"][] = "honeydesign-footer1.php";
$eb_all_themes_support[$eb_all_themes_name]["footer"][] = "echbaytwo-footer3.php";
//
//$eb_all_themes_support[$eb_all_themes_name]["home"][] = "honeydesign-home1.php";
$eb_all_themes_support[$eb_all_themes_name]["home"][] = "home_widget.php";
//
$eb_all_themes_support[$eb_all_themes_name]["threaddetails"][] = "honeydesign-threaddetails.html";
//
$eb_all_themes_support[$eb_all_themes_name]["threadnode"][] = "honeydesign-threadnode.html";
