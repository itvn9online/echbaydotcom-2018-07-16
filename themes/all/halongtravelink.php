...
//
$eb_all_themes_support[$eb_all_themes_name]["top"][] = "halongtravelink-top1.php";
...
$eb_all_themes_support[$eb_all_themes_name]["footer"][] = "halongtravelink-footer1.php";
$eb_all_themes_support[$eb_all_themes_name]["footer"][] = "echbaytwo-footer3.php";
//
//$eb_all_themes_support[$eb_all_themes_name]["home"][] = "halongtravelink-home1.php";
$eb_all_themes_support[$eb_all_themes_name]["home"][] = "home_widget.php";
//
$eb_all_themes_support[$eb_all_themes_name]["threaddetails"][] = "halongtravelink-threaddetails.html";
//
$eb_all_themes_support[$eb_all_themes_name]["threadnode"][] = "halongtravelink-threadnode.html";
